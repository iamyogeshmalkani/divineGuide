        ...
        <div className='blog_card'>
            <div className='blogs_card_head  flex-row'>
                <div className='head_img'>
                    <img src={`images/${props.blog.avatar}.png`}></img>
                </div>
                <div className='header_info'>
                    <h5>{props.blog.creator}</h5>
                    <p className='text-content'>{new Date().toJSON().slice(0, 10)}</p>
                </div>
            </div>
            <div className='blog_content'>
                ...
                <p style={{ display: props.blog.desc ? 'block' : 'none' }}>{props.blog.desc}</p>
            </div>
        </div >
    )
}
