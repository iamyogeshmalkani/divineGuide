                ...
                <div class="container">
                    <div class="row testimonials_cards_row">
                        ...
                        <div class="col-12 d-flex justify-content-between">
                            <button type="button" class="btn" href="#carouselExampleIndicators2" role="button" data-slide="next">
                                <i class="fa-solid fa-circle-chevron-left"></i>
                            </button>
                            <button class="btn " href="#carouselExampleIndicators2" role="button" data-slide="next">
